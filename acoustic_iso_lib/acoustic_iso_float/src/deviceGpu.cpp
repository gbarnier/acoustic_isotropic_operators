...
// Constructor #1
deviceGpu::deviceGpu(const std::shared_ptr<float1DReg> zCoord, const std::shared_ptr<float1DReg> xCoord, const std::shared_ptr<float2DReg> vel, int &nt) {
...
// Constructor #2
deviceGpu::deviceGpu(const std::vector<int> &zGridVector, const std::vector<int> &xGridVector, const std::shared_ptr<float2DReg> vel, int &nt) {
...
// Constructor #3
deviceGpu::deviceGpu(const int &nzDevice, const int &ozDevice, const int &dzDevice , const int &nxDevice, const int &oxDevice, const int &dxDevice, const std::shared_ptr<float2DReg> vel, int &nt){
