...
void allocateBornShotsGpu(float *vel2Dtw2, float *reflectivityScale, int iGpu, int iGpuId){
	...
	cuda_call(cudaMalloc((void**) &dev_modelBorn[iGpu], host_nz*host_nx*sizeof(float)));
...
void BornShotsFwdGpu(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *scatWavefieldDts, int iGpu, int iGpuId){
	...
	cuda_call(cudaMemset(dev_BornSrcWavefield[iGpu], 0, host_nz*host_nx*host_nts*sizeof(float))); // Initialize wavefield on device
	...
	cuda_call(cudaMemcpy(dev_modelBorn[iGpu], model, host_nz*host_nx*sizeof(float), cudaMemcpyHostToDevice)); // Copy model (reflectivity) on device
...
/****************************** Free surface **********************************/
void BornShotsFwdFsGpu(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *scatWavefieldDts, int iGpu, int iGpuId){
...
void BornShotsFwdFsGpuWavefield(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *scatWavefieldDts, int iGpu, int iGpuId){
...
void BornShotsAdjGpu(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *recWavefieldDts, int iGpu, int iGpuId){
	...
	// Model
  	cuda_call(cudaMemset(dev_modelBorn[iGpu], 0, host_nz*host_nx*sizeof(float))); // Initialize model on device
	...
	cuda_call(cudaMemcpy(model, dev_modelBorn[iGpu], host_nz*host_nx*sizeof(float), cudaMemcpyDeviceToHost));
...
/****************************** Free surface **********************************/
void BornShotsAdjFsGpu(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *recWavefieldDts, int iGpu, int iGpuId){
...
void BornShotsAdjFsGpuWavefield(float *model, float *dataRegDts, float *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, float *srcWavefieldDts, float *recWavefieldDts, int iGpu, int iGpuId){
