...
void computeTomoSrcWfldDt2Fs(double *dev_sourcesIn, double *dev_wavefieldOut, int *dev_sourcesPositionsRegIn, int nSourcesRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockXIn, int iGpu);
...
void computeTomoRecWfldFs(double *dev_dataIn, double *dev_wavefieldOut, int *dev_receiversPositionsRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int iGpu);
...
void computeTomoLeg1TimeFwdFs(double *dev_modelIn, double *dev_tomoSrcWavefieldDt2In, double *dev_dataOut, double *dev_wavefield1Out, double *dev_wavefield2Out, double *dev_extReflectivityIn, int *dev_receiversPositionRegIn, int nReceiversRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg2TimeFwdFs(double *dev_modelIn, double *dev_tomoSrcWavefieldDt2In, double *dev_dataOut, double *dev_wavefield1Out, double *dev_wavefield2Out, double *dev_extReflectivityIn, int *dev_receiversPositionRegIn, int nReceiversRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg1OffsetFwdFs(double *dev_modelIn, double *dev_tomoSrcWavefieldDt2In, double *dev_dataOut, double *dev_wavefield1Out, double *dev_wavefield2Out, double *dev_extReflectivityIn, int *dev_receiversPositionRegIn, int nReceiversRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg2OffsetFwdFs(double *dev_modelIn, double *dev_tomoSrcWavefieldDt2In, double *dev_dataOut, double *dev_wavefield1Out, double *dev_wavefield2Out, double *dev_extReflectivityIn, int *dev_receiversPositionRegIn, int nReceiversRegIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockDataIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg1TimeAdjFs(double *dev_tomoSrcWavefieldDt2In, double *dev_tomoRecWavefieldIn, double *dev_modelTomoOut, double *dev_wavefield1Out, double *dev_extReflectivityIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg2TimeAdjFs(double *dev_tomoSrcWavefieldDt2In, double *dev_tomoRecWavefieldIn, double *dev_modelTomoOut, double *dev_wavefield1Out, double *dev_extReflectivityIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, int saveWavefield);
...
void computeTomoLeg1OffsetAdjFs(double *dev_tomoSrcWavefieldDt2In, double *dev_tomoRecWavefieldIn, double *dev_modelTomoOut, double *dev_wavefield1Out, double *dev_extReflectivityIn, dim3 dimGridIn, dim3 dimBlockIn, int nBlockXIn, int iGpu, int saveWavefield);
...
void computeTomoLeg2OffsetAdjFs(double *dev_tomoSrcWavefieldDt2In, double *dev_tomoRecWavefieldIn, double *dev_modelTomoOut, double *dev_wavefield1Out, double *dev_extReflectivityIn, dim3 dimGridIn, dim3 dimBlockIn, int iGpu, int saveWavefield);
