...
// Constructor #1
deviceGpu::deviceGpu(const std::shared_ptr<double1DReg> zCoord, const std::shared_ptr<double1DReg> xCoord, const std::shared_ptr<double2DReg> vel, int &nt, int dipole, double zDipoleShift, double xDipoleShift) {
...
// Constructor #2
deviceGpu::deviceGpu(const std::vector<int> &zGridVector, const std::vector<int> &xGridVector, const std::shared_ptr<double2DReg> vel, int &nt, int dipole, int zDipoleShift, int xDipoleShift) {
...
// Constructor #3
deviceGpu::deviceGpu(const int &nzDevice, const int &ozDevice, const int &dzDevice , const int &nxDevice, const int &oxDevice, const int &dxDevice, const std::shared_ptr<double2DReg> vel, int &nt, int dipole, int zDipoleShift, int xDipoleShift){
