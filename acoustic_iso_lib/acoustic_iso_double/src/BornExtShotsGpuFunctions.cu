...
void allocateBornExtShotsGpu(double *vel2Dtw2, double *reflectivityScale, int iGpu, int iGpuId){
	...
	cuda_call(cudaMalloc((void**) &dev_modelBornExt[iGpu], host_nz*host_nx*host_nExt*sizeof(double)));

	// Allocate source wavefield
	cuda_call(cudaMalloc((void**) &dev_BornSrcWavefield[iGpu], host_nz*host_nx*host_nts*sizeof(double))); // We store the source wavefield
...
// Time-lags
void BornTimeShotsFwdGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *scatWavefieldDts, int sloth, int iGpu, int iGpuId){
	...
	cuda_call(cudaMemset(dev_BornSrcWavefield[iGpu], 0, host_nz*host_nx*host_nts*sizeof(double)));
	...
	cuda_call(cudaMemcpy(dev_modelBornExt[iGpu], model, host_nz*host_nx*host_nExt*sizeof(double), cudaMemcpyHostToDevice)); // Copy extended model (reflectivity) on device
...
void BornTimeShotsFwdGpuWavefield(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *scatWavefieldDts, int iGpu, int iGpuId){
	...
	// Allocate and copy model
	cuda_call(cudaMemcpy(dev_modelBornExt[iGpu], model, host_nz*host_nx*host_nExt*sizeof(double), cudaMemcpyHostToDevice)); // Copy model (reflectivity) on device
...
/********************************** Free surface ******************************/
// Time-lags
void BornTimeShotsFwdFsGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *scatWavefieldDts, int iGpu, int iGpuId){
...
/********************************** Normal ************************************/
// Time-lags
void BornTimeShotsAdjGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int sloth, int iGpu, int iGpuId){
	...
	// Model
  	cuda_call(cudaMemset(dev_modelBornExt[iGpu], 0, host_nz*host_nx*host_nExt*sizeof(double))); // Initialize model on device
	...
	cuda_call(cudaMemcpy(model, dev_modelBornExt[iGpu], host_nz*host_nx*host_nExt*sizeof(double), cudaMemcpyDeviceToHost));
...
void BornTimeShotsAdjGpuWavefield(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
	...
	// Model
  	cuda_call(cudaMemset(dev_modelBornExt[iGpu], 0, host_nz*host_nx*host_nExt*sizeof(double)));
...
// Subsurface offsets
void BornOffsetShotsAdjGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
...
void BornOffsetShotsAdjGpuWavefield(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
...
/********************************** Free surface ******************************/
// Time-lags
void BornTimeShotsAdjFsGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
...
void BornTimeShotsAdjFsGpuWavefield(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
...
// Subsurface offsets
void BornOffsetShotsAdjFsGpu(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
...
void BornOffsetShotsAdjFsGpuWavefield(double *model, double *dataRegDts, double *sourcesSignals, int *sourcesPositionReg, int nSourcesReg, int *receiversPositionReg, int nReceiversReg, double *srcWavefieldDts, double *recWavefieldDts, int iGpu, int iGpuId){
