...
class fdParam{
 	...
 	public:
		...
		// QC stuff 
		bool checkParfileConsistencyTime(const std::shared_ptr<double2DReg> seismicTraces, int timeAxisIndex=1) const;	
		bool checkParfileConsistencySpace(const std::shared_ptr<double2DReg> model) const;
