...
WaveReconV9::WaveReconV9(const std::shared_ptr<SEP::float3DReg>model,
                         const std::shared_ptr<SEP::float3DReg>data,
                         const std::shared_ptr<SEP::float2DReg>slsqModel,
                         float                                     U_0,
                         float 					alpha,
			 int					spongeWidth) {
std::cerr << "VERSION 9" << std::endl;
...
void WaveReconV9::set_slsq(std::shared_ptr<SEP::float2DReg>slsq){
	_slsq=slsq;
}

void WaveReconV9::forward(const bool                         add,
...
void WaveReconV9::adjoint(const bool                         add,
