...
// Constructor #1
spaceInterp::spaceInterp(const std::shared_ptr<float1DReg> zCoord, const std::shared_ptr<float1DReg> xCoord, const std::shared_ptr<SEP::hypercube> vpParamHypercube, int &nt, std::string interpMethod, int nFilt) {
...
void spaceInterp::calcLinearWeights(){
...
void spaceInterp::calcSincWeights(){
	for (int iDevice = 0; iDevice < _nDeviceIrreg; iDevice++) {
...
void spaceInterp::calcGaussWeights(){
	for (int iDevice = 0; iDevice < _nDeviceIrreg; iDevice++) {
		int gridPointIndexOffset = iDevice*_nFiltTotal;
...
//
// // Constructor #2
// spaceInterp::spaceInterp(const std::vector<int> &zGridVector, const std::vector<int> &xGridVector, const std::shared_ptr<SEP::hypercube> vpParamHypercube, int &nt) {
//
// 	_vpParamHypercube = vpParamHypercube;
// 	_nt = nt;
// 	_nDeviceIrreg = zGridVector.size(); // Nb of device
// 	int _nz = _vpParamHypercube->getAxis(1).n;
...
//
// // Constructor #3
// spaceInterp::spaceInterp(const int &nzDevice, const int &ozDevice, const int &dzDevice , const int &nxDevice, const int &oxDevice, const int &dxDevice, const std::shared_ptr<SEP::hypercube> vpParamHypercube, int &nt){
//
// 	_vpParamHypercube = vpParamHypercube;
// 	_nt = nt;
...
void spaceInterp::convertIrregToReg() {
...
void spaceInterp::checkOutOfBounds(const std::shared_ptr<float1DReg> zCoord, const std::shared_ptr<float1DReg> xCoord){
...
void spaceInterp::checkOutOfBounds(const std::vector<int> &zGridVector, const std::vector<int> &xGridVector){
...
void spaceInterp::checkOutOfBounds(const int &nzDevice, const int &ozDevice, const int &dzDevice , const int &nxDevice, const int &oxDevice, const int &dxDevice){
...
void spaceInterp_multi_exp::adjoint(const bool add, std::shared_ptr<float2DReg> signalReg, const std::shared_ptr<float2DReg> signalIrreg) const {
	...
	// Constructor #1
	spaceInterp_multi_exp_complex::spaceInterp_multi_exp_complex(const std::shared_ptr<float1DReg> zCoord, const std::shared_ptr<float1DReg> xCoord, const std::shared_ptr<float1DReg> expIndex, const std::shared_ptr<SEP::hypercube> vpParamHypercube, int &nt, std::string interpMethod, int nFilt) {
	...
	void spaceInterp_multi_exp_complex::calcLinearWeights(){
		for (int iDevice = 0; iDevice < _nDeviceIrreg; iDevice++) {
	...
	void spaceInterp_multi_exp_complex::calcSincWeights(){
		for (int iDevice = 0; iDevice < _nDeviceIrreg; iDevice++) {
			int gridPointIndexOffset = iDevice*_nFiltTotal;
	...
	void spaceInterp_multi_exp_complex::calcGaussWeights(){
		for (int iDevice = 0; iDevice < _nDeviceIrreg; iDevice++) {
			int gridPointIndexOffset = iDevice*_nFiltTotal;
	...
	void spaceInterp_multi_exp_complex::convertIrregToReg() {
	...
	void spaceInterp_multi_exp_complex::forward(const bool add, const std::shared_ptr<complex2DReg> signalReg, std::shared_ptr<complex2DReg> signalIrreg) const {
	...
	void spaceInterp_multi_exp_complex::adjoint(const bool add, std::shared_ptr<complex2DReg> signalReg, const std::shared_ptr<complex2DReg> signalIrreg) const {
		...
		void spaceInterp_multi_exp_complex::checkOutOfBounds(const std::shared_ptr<float1DReg> zCoord, const std::shared_ptr<float1DReg> xCoord){
		...
		void spaceInterp_multi_exp_complex::checkOutOfBounds(const std::vector<int> &zGridVector, const std::vector<int> &xGridVector){
		...
		void spaceInterp_multi_exp_complex::checkOutOfBounds(const int &nzDevice, const int &ozDevice, const int &dzDevice , const int &nxDevice, const int &oxDevice, const int &dxDevice){
		...
		void spaceInterp_multi_exp_complex::getInfo(){
