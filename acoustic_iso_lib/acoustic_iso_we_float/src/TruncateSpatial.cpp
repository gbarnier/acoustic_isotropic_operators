...
// std::shared_ptr<giee::float3DReg>model,
//                                  const std::shared_ptr<giee::float2DReg>data,
//                                  const
// std::shared_ptr<giee::float1DReg>xCoordinates,
//                                  const
// std::shared_ptr<giee::float1DReg>zCoordinates)
TruncateSpatial::TruncateSpatial(const std::shared_ptr<giee::float3DReg>model,
                                 const std::shared_ptr<giee::float2DReg>data,
                                 ...
                                 const std::shared_ptr<giee::float3DReg>data)
{
  ...
  // std::shared_ptr<giee::float1DReg> xCoordinates(new float1DReg(n3d
  // *n2d,xCoordArray));
  // std::shared_ptr<giee::float1DReg> zCoordinates(new float1DReg(n3d
  // *n2d,zCoordArray));
...
// irregular grid
void TruncateSpatial::pullToData(const std::shared_ptr<giee::Vector>model,
...
// irregular grid
void TruncateSpatial::pushToModel(std::shared_ptr<giee::Vector>          model,
                                  const std::shared_ptr<giee::float2DReg>data) {
