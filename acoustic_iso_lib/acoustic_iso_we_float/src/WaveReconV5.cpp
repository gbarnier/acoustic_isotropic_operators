...
WaveReconV5::WaveReconV5(const std::shared_ptr<SEP::float3DReg>model,
...
void WaveReconV5::forward(const bool                         add,
...
void WaveReconV5::adjoint(const bool                         add,
  ...
  for (int ix = FAT; ix < n2-FAT; ix++) { //x
    for (int iz = FAT; iz < n1-FAT; iz++) { //z
      (*m)[0][ix][iz] +=   //second time deriv
                         (C5t*((*sp)[ix][iz]*(*d)[0 + 5][ix ][iz]))*(*s)[ix][iz] + \
                         //initial condition 
       			 (*d)[0][ix ][iz ];
      (*m)[1][ix][iz] +=   //second time deriv
                         (C4t*((*sp)[ix][iz]*(*d)[1 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[1 + 5][ix ][iz]))*(*s)[ix][iz] + \
                         //initial condition 
       			 (*d)[1][ix ][iz ];
      (*m)[2][ix][iz] +=   //second time deriv
                         (C3t*((*sp)[ix][iz]*(*d)[2 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[2 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[2 + 5][ix ][iz]))*(*s)[ix][iz] + \
                         //initial condition 
       			 (*d)[2][ix ][iz ];
      (*m)[3][ix][iz] +=   //second time deriv
                         (C2t*((*sp)[ix][iz]*(*d)[3 + 2][ix ][iz]) + \
                         C3t*((*sp)[ix][iz]*(*d)[3 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[3 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[3 + 5][ix ][iz]))*(*s)[ix][iz] + \
                         //initial condition 
       			 (*d)[3][ix ][iz ];
      (*m)[4][ix][iz] +=   //second time deriv
                         (C1t*((*sp)[ix][iz]*(*d)[4 + 1][ix ][iz]) + \
                         C2t*((*sp)[ix][iz]*(*d)[4 + 2][ix ][iz]) + \
                         C3t*((*sp)[ix][iz]*(*d)[4 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[4 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[4 + 5][ix ][iz]))*(*s)[ix][iz]+ \
                         //initial condition 
       			 (*d)[4][ix ][iz ];
      (*m)[5][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[5][ix ][iz ]+ \
                         C1t*((*sp)[ix][iz]*(*d)[5 + 1][ix ][iz]) + \
                         C2t*((*sp)[ix][iz]*(*d)[5 + 2][ix ][iz]) + \
                         C3t*((*sp)[ix][iz]*(*d)[5 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[5 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[5 + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[5][ix ][iz ] + \
      ...
      (*m)[6][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[6][ix ][iz ]+ \
                         C1t*((*d)[6-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[6 + 1][ix ][iz]) + \
                         C2t*((*sp)[ix][iz]*(*d)[6 + 2][ix ][iz]) + \
                         C3t*((*sp)[ix][iz]*(*d)[6 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[6 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[6 + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[6][ix ][iz ] + \
      ...
      (*m)[7][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[7][ix ][iz ]+ \
                         C1t*((*d)[7-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[7 + 1][ix ][iz]) + \
                         C2t*((*d)[7-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[7 + 2][ix ][iz]) + \
                         C3t*((*sp)[ix][iz]*(*d)[7 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[7 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[7 + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[7][ix ][iz ] + \
      ...
      (*m)[8][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[8][ix ][iz ]+ \
                         C1t*((*d)[8-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[8 + 1][ix ][iz]) + \
                         C2t*((*d)[8-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[8 + 2][ix ][iz]) + \
                         C3t*((*d)[8-3][ix ][iz ] + (*sp)[ix][iz]*(*d)[8 + 3][ix ][iz]) + \
                         C4t*((*sp)[ix][iz]*(*d)[8 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[8 + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[8][ix ][iz ] + \
      ...
      (*m)[9][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[9][ix ][iz ]+ \
                         C1t*((*d)[9-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[9 + 1][ix ][iz]) + \
                         C2t*((*d)[9-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[9 + 2][ix ][iz]) + \
                         C3t*((*d)[9-3][ix ][iz ] + (*sp)[ix][iz]*(*d)[9 + 3][ix ][iz]) + \
                         C4t*((*d)[9-4][ix ][iz ] + (*sp)[ix][iz]*(*d)[9 + 4][ix ][iz]) + \
                         C5t*((*sp)[ix][iz]*(*d)[9 + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[9][ix ][iz ] + \
                         C1x * ((*d)[9][ix + 1 ][iz ] + (*d)[9][ix - 1 ][iz ]) + \
                         C2x * ((*d)[9][ix + 2 ][iz ] + (*d)[9][ix - 2 ][iz ]) + \
                         C3x * ((*d)[9][ix + 3 ][iz ] + (*d)[9][ix - 3 ][iz ]) + \
                         C4x * ((*d)[9][ix + 4 ][iz ] + (*d)[9][ix - 4 ][iz ]) + \
                         C5x * ((*d)[9][ix + 5 ][iz ] + (*d)[9][ix - 5 ][iz ]) + \
                         C0z * ((*d)[9][ix ][iz ]) + \
                         C1z * ((*d)[9][ix ][iz + 1 ] + (*d)[9][ix ][iz - 1 ]) + \
                         C2z * ((*d)[9][ix ][iz + 2 ] + (*d)[9][ix ][iz - 2 ]) + \
                         C3z * ((*d)[9][ix ][iz + 3 ] + (*d)[9][ix ][iz - 3 ]) + \
                         C4z * ((*d)[9][ix ][iz + 4 ] + (*d)[9][ix ][iz - 4 ]) + \
                         C5z * ((*d)[9][ix ][iz + 5 ] + (*d)[9][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-5][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[n3-5][ix ][iz ]+ \
                         C1t*((*d)[n3-5-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-5 + 1][ix ][iz]) + \
                         C2t*((*d)[n3-5-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-5 + 2][ix ][iz]) + \
                         C3t*((*d)[n3-5-3][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-5 + 3][ix ][iz]) + \
                         C4t*((*d)[n3-5-4][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-5 + 4][ix ][iz]) + \
                         C5t*((*d)[n3-5-5][ix ][iz ]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[n3-5][ix ][iz ] + \
      ...
      (*m)[n3-4][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[n3-4][ix ][iz ]+ \
                         C1t*((*d)[n3-4-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-4 + 1][ix ][iz]) + \
                         C2t*((*d)[n3-4-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-4 + 2][ix ][iz]) + \
                         C3t*((*d)[n3-4-3][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-4 + 3][ix ][iz]) + \
                         C4t*((*d)[n3-4-4][ix ][iz ]) + \
                         C5t*((*d)[n3-4-5][ix ][iz ]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[n3-4][ix ][iz ] + \
      ...
      (*m)[n3-3][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[n3-3][ix ][iz ]+ \
                         C1t*((*d)[n3-3-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-3 + 1][ix ][iz]) + \
                         C2t*((*d)[n3-3-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-3 + 2][ix ][iz]) + \
                         C3t*((*d)[n3-3-3][ix ][iz ]) + \
                         C4t*((*d)[n3-3-4][ix ][iz ]) + \
                         C5t*((*d)[n3-3-5][ix ][iz ]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[n3-3][ix ][iz ] + \
      ...
      (*m)[n3-2][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[n3-2][ix ][iz ]+ \
                         C1t*((*d)[n3-2-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[n3-2 + 1][ix ][iz]) + \
                         C2t*((*d)[n3-2-2][ix ][iz ]) + \
                         C3t*((*d)[n3-2-3][ix ][iz ]) + \
                         C4t*((*d)[n3-2-4][ix ][iz ]) + \
                         C5t*((*d)[n3-2-5][ix ][iz ]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[n3-2][ix ][iz ] + \
                         C1x * ((*d)[n3-2][ix + 1 ][iz ] + (*d)[n3-2][ix - 1 ][iz ]) + \
                         C2x * ((*d)[n3-2][ix + 2 ][iz ] + (*d)[n3-2][ix - 2 ][iz ]) + \
                         C3x * ((*d)[n3-2][ix + 3 ][iz ] + (*d)[n3-2][ix - 3 ][iz ]) + \
                         C4x * ((*d)[n3-2][ix + 4 ][iz ] + (*d)[n3-2][ix - 4 ][iz ]) + \
                         C5x * ((*d)[n3-2][ix + 5 ][iz ] + (*d)[n3-2][ix - 5 ][iz ]) + \
                         C0z * ((*d)[n3-2][ix ][iz ]) + \
                         C1z * ((*d)[n3-2][ix ][iz + 1 ] + (*d)[n3-2][ix ][iz - 1 ]) + \
                         C2z * ((*d)[n3-2][ix ][iz + 2 ] + (*d)[n3-2][ix ][iz - 2 ]) + \
                         C3z * ((*d)[n3-2][ix ][iz + 3 ] + (*d)[n3-2][ix ][iz - 3 ]) + \
                         C4z * ((*d)[n3-2][ix ][iz + 4 ] + (*d)[n3-2][ix ][iz - 4 ]) + \
                         C5z * ((*d)[n3-2][ix ][iz + 5 ] + (*d)[n3-2][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-1][ix][iz] +=   //second time deriv
       			 (C0t*(*sp)[ix][iz]* (*d)[n3-1][ix ][iz ]+ \
                         C1t*((*d)[n3-1-1][ix ][iz ]) + \
                         C2t*((*d)[n3-1-2][ix ][iz ]) + \
                         C3t*((*d)[n3-1-3][ix ][iz ]) + \
                         C4t*((*d)[n3-1-4][ix ][iz ]) + \
                         C5t*((*d)[n3-1-5][ix ][iz ]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[n3-1][ix ][iz ] + \
                         ...
                         C5z * ((*d)[n3-1][ix ][iz + 5 ] + (*d)[n3-1][ix ][iz - 5 ]))*(*sp)[ix][iz];
    }
  }
