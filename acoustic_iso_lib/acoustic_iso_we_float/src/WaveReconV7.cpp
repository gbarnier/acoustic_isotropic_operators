...
WaveReconV7::WaveReconV7(const std::shared_ptr<SEP::float3DReg>model,
                         const std::shared_ptr<SEP::float3DReg>data,
                         const std::shared_ptr<SEP::float2DReg>slsqModel,
                         int                                    boundaryCond,
			 int					spongeWidth) {
std::cerr << "VERSION 7" << std::endl;
...
void WaveReconV7::forward(const bool                         add,
  ...
  for (int ix = FAT; ix < n2-FAT; ix++) { //x
    for (int iz = FAT; iz < n1-FAT; iz++) { //z
      (*d)[0][ix][iz] += //second time deriv
		//C0t_2*((*sp)[ix][iz] * (*m)[1][ix ][iz ])*(*s)[ix][iz] -
       		(C0t_2*(*sp)[ix][iz]* (*m)[1][ix ][iz ] + \
                C1t_2*((*sp)[ix][iz] * (*m)[1-1][ix ][iz ]+(*m)[1+1][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
                (C0x * (*sp)[ix][iz]*(*m)[1][ix ][iz ] + \
                C1x * ((*sp)[ix+1][iz]*(*m)[1][ix + 1 ][iz ] + (*sp)[ix-1][iz]*(*m)[1][ix - 1 ][iz ]) + \
                C2x * ((*sp)[ix+2][iz]*(*m)[1][ix + 2 ][iz ] + (*sp)[ix-2][iz]*(*m)[1][ix - 2 ][iz ]) + \
                C3x * ((*sp)[ix+3][iz]*(*m)[1][ix + 3 ][iz ] + (*sp)[ix-3][iz]*(*m)[1][ix - 3 ][iz ]) + \
                C4x * ((*sp)[ix+4][iz]*(*m)[1][ix + 4 ][iz ] + (*sp)[ix-4][iz]*(*m)[1][ix - 4 ][iz ]) + \
                C5x * ((*sp)[ix+5][iz]*(*m)[1][ix + 5 ][iz ] + (*sp)[ix-5][iz]*(*m)[1][ix - 5 ][iz ]) + \
                C0z * ((*sp)[ix][iz]*(*m)[1][ix ][iz ]) + \
                C1z * ((*sp)[ix][iz+1]*(*m)[1][ix ][iz + 1 ] + (*sp)[ix][iz-1]*(*m)[1][ix ][iz - 1 ]) + \
                C2z * ((*sp)[ix][iz+2]*(*m)[1][ix ][iz + 2 ] + (*sp)[ix][iz-2]*(*m)[1][ix ][iz - 2 ]) + \
                C3z * ((*sp)[ix][iz+3]*(*m)[1][ix ][iz + 3 ] + (*sp)[ix][iz-3]*(*m)[1][ix ][iz - 3 ]) + \
                C4z * ((*sp)[ix][iz+4]*(*m)[1][ix ][iz + 4 ] + (*sp)[ix][iz-4]*(*m)[1][ix ][iz - 4 ]) + \
                C5z * ((*sp)[ix][iz+5]*(*m)[1][ix ][iz + 5 ] + (*sp)[ix][iz-5]*(*m)[1][ix ][iz - 5 ]));
      (*d)[1][ix][iz] += //second time deriv
       		//C0t_4*((*sp)[ix][iz] * (*m)[2][ix ][iz ])*(*s)[ix][iz]  -
       		(C0t_4*(*sp)[ix][iz]* (*m)[2][ix ][iz ] + \
                C1t_4*((*sp)[ix][iz] * (*m)[2-1][ix ][iz ]+(*m)[2 + 1][ix ][iz]) + \
                C2t_4*((*sp)[ix][iz] * (*m)[2-2][ix ][iz ]+(*m)[2 + 2][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
                (C0x * (*sp)[ix][iz]*(*m)[2][ix ][iz ] + \
                C1x * ((*sp)[ix+1][iz]*(*m)[2][ix + 1 ][iz ] + (*sp)[ix-1][iz]*(*m)[2][ix - 1 ][iz ]) + \
                C2x * ((*sp)[ix+2][iz]*(*m)[2][ix + 2 ][iz ] + (*sp)[ix-2][iz]*(*m)[2][ix - 2 ][iz ]) + \
                C3x * ((*sp)[ix+3][iz]*(*m)[2][ix + 3 ][iz ] + (*sp)[ix-3][iz]*(*m)[2][ix - 3 ][iz ]) + \
                C4x * ((*sp)[ix+4][iz]*(*m)[2][ix + 4 ][iz ] + (*sp)[ix-4][iz]*(*m)[2][ix - 4 ][iz ]) + \
                C5x * ((*sp)[ix+5][iz]*(*m)[2][ix + 5 ][iz ] + (*sp)[ix-5][iz]*(*m)[2][ix - 5 ][iz ]) + \
                C0z * ((*sp)[ix][iz]*(*m)[2][ix ][iz ]) + \
                C1z * ((*sp)[ix][iz+1]*(*m)[2][ix ][iz + 1 ] + (*sp)[ix][iz-1]*(*m)[2][ix ][iz - 1 ]) + \
                C2z * ((*sp)[ix][iz+2]*(*m)[2][ix ][iz + 2 ] + (*sp)[ix][iz-2]*(*m)[2][ix ][iz - 2 ]) + \
                C3z * ((*sp)[ix][iz+3]*(*m)[2][ix ][iz + 3 ] + (*sp)[ix][iz-3]*(*m)[2][ix ][iz - 3 ]) + \
                C4z * ((*sp)[ix][iz+4]*(*m)[2][ix ][iz + 4 ] + (*sp)[ix][iz-4]*(*m)[2][ix ][iz - 4 ]) + \
                C5z * ((*sp)[ix][iz+5]*(*m)[2][ix ][iz + 5 ] + (*sp)[ix][iz-5]*(*m)[2][ix ][iz - 5 ]));
      (*d)[2][ix][iz] += //second time deriv
		//C0t_6*((*sp)[ix][iz] * (*m)[3][ix ][iz ])*(*s)[ix][iz]  -
       		(C0t_6*(*sp)[ix][iz]* (*m)[3][ix ][iz ] + \
                C1t_6*((*sp)[ix][iz] * (*m)[3-1][ix ][iz ]+(*m)[3 + 1][ix ][iz]) + \
                C2t_6*((*sp)[ix][iz] * (*m)[3-2][ix ][iz ]+(*m)[3 + 2][ix ][iz]) + \
                C3t_6*((*sp)[ix][iz] * (*m)[3-3][ix ][iz ]+(*m)[3 + 3][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
                (C0x * (*sp)[ix][iz]*(*m)[3][ix ][iz ] + \
                C1x * ((*sp)[ix+1][iz]*(*m)[3][ix + 1 ][iz ] + (*sp)[ix-1][iz]*(*m)[3][ix - 1 ][iz ]) + \
                C2x * ((*sp)[ix+2][iz]*(*m)[3][ix + 2 ][iz ] + (*sp)[ix-2][iz]*(*m)[3][ix - 2 ][iz ]) + \
                C3x * ((*sp)[ix+3][iz]*(*m)[3][ix + 3 ][iz ] + (*sp)[ix-3][iz]*(*m)[3][ix - 3 ][iz ]) + \
                C4x * ((*sp)[ix+4][iz]*(*m)[3][ix + 4 ][iz ] + (*sp)[ix-4][iz]*(*m)[3][ix - 4 ][iz ]) + \
                C5x * ((*sp)[ix+5][iz]*(*m)[3][ix + 5 ][iz ] + (*sp)[ix-5][iz]*(*m)[3][ix - 5 ][iz ]) + \
                C0z * ((*sp)[ix][iz]*(*m)[3][ix ][iz ]) + \
                C1z * ((*sp)[ix][iz+1]*(*m)[3][ix ][iz + 1 ] + (*sp)[ix][iz-1]*(*m)[3][ix ][iz - 1 ]) + \
                C2z * ((*sp)[ix][iz+2]*(*m)[3][ix ][iz + 2 ] + (*sp)[ix][iz-2]*(*m)[3][ix ][iz - 2 ]) + \
                C3z * ((*sp)[ix][iz+3]*(*m)[3][ix ][iz + 3 ] + (*sp)[ix][iz-3]*(*m)[3][ix ][iz - 3 ]) + \
                C4z * ((*sp)[ix][iz+4]*(*m)[3][ix ][iz + 4 ] + (*sp)[ix][iz-4]*(*m)[3][ix ][iz - 4 ]) + \
                C5z * ((*sp)[ix][iz+5]*(*m)[3][ix ][iz + 5 ] + (*sp)[ix][iz-5]*(*m)[3][ix ][iz - 5 ]));
      (*d)[3][ix][iz] += //second time deriv
		//C0t_8*((*sp)[ix][iz] * (*m)[4][ix ][iz ])*(*s)[ix][iz]  -
       		(C0t_8*(*sp)[ix][iz]* (*m)[4][ix ][iz ] + \
                C1t_8*((*sp)[ix][iz] * (*m)[4-1][ix ][iz ]+(*m)[4 + 1][ix ][iz]) + \
                C2t_8*((*sp)[ix][iz] * (*m)[4-2][ix ][iz ]+(*m)[4 + 2][ix ][iz]) + \
                C3t_8*((*sp)[ix][iz] * (*m)[4-3][ix ][iz ]+(*m)[4 + 3][ix ][iz])  + \
                C4t_8*((*sp)[ix][iz] * (*m)[4-4][ix ][iz ]+(*m)[4 + 4][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
                (C0x * (*sp)[ix][iz]*(*m)[4][ix ][iz ] + \
                C1x * ((*sp)[ix+1][iz]*(*m)[4][ix + 1 ][iz ] + (*sp)[ix-1][iz]*(*m)[4][ix - 1 ][iz ]) + \
                C2x * ((*sp)[ix+2][iz]*(*m)[4][ix + 2 ][iz ] + (*sp)[ix-2][iz]*(*m)[4][ix - 2 ][iz ]) + \
                C3x * ((*sp)[ix+3][iz]*(*m)[4][ix + 3 ][iz ] + (*sp)[ix-3][iz]*(*m)[4][ix - 3 ][iz ]) + \
                C4x * ((*sp)[ix+4][iz]*(*m)[4][ix + 4 ][iz ] + (*sp)[ix-4][iz]*(*m)[4][ix - 4 ][iz ]) + \
                C5x * ((*sp)[ix+5][iz]*(*m)[4][ix + 5 ][iz ] + (*sp)[ix-5][iz]*(*m)[4][ix - 5 ][iz ]) + \
                C0z * ((*sp)[ix][iz]*(*m)[4][ix ][iz ]) + \
                C1z * ((*sp)[ix][iz+1]*(*m)[4][ix ][iz + 1 ] + (*sp)[ix][iz-1]*(*m)[4][ix ][iz - 1 ]) + \
                C2z * ((*sp)[ix][iz+2]*(*m)[4][ix ][iz + 2 ] + (*sp)[ix][iz-2]*(*m)[4][ix ][iz - 2 ]) + \
                C3z * ((*sp)[ix][iz+3]*(*m)[4][ix ][iz + 3 ] + (*sp)[ix][iz-3]*(*m)[4][ix ][iz - 3 ]) + \
                C4z * ((*sp)[ix][iz+4]*(*m)[4][ix ][iz + 4 ] + (*sp)[ix][iz-4]*(*m)[4][ix ][iz - 4 ]) + \
                C5z * ((*sp)[ix][iz+5]*(*m)[4][ix ][iz + 5 ] + (*sp)[ix][iz-5]*(*m)[4][ix ][iz - 5 ]));
      (*d)[n3-6][ix][iz] += //second time deriv
		//C0t_8*((*sp)[ix][iz] * (*m)[n3-5][ix ][iz ])*(*s)[ix][iz]  - 
       		(C0t_8*(*sp)[ix][iz]* (*m)[n3-5][ix ][iz ]+ \
                C1t_8*((*sp)[ix][iz] * (*m)[n3-5-1][ix ][iz ]+(*m)[n3-5 + 1][ix ][iz]) + \
                C2t_8*((*sp)[ix][iz] * (*m)[n3-5-2][ix ][iz ]+(*m)[n3-5 + 2][ix ][iz]) + \
                C3t_8*((*sp)[ix][iz] * (*m)[n3-5-3][ix ][iz ]+(*m)[n3-5 + 3][ix ][iz])  + \
                C4t_8*((*sp)[ix][iz] * (*m)[n3-5-4][ix ][iz ]+(*m)[n3-5 + 4][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
      ...
      (*d)[n3-5][ix][iz] += //second time deriv
		//C0t_6*((*sp)[ix][iz] * (*m)[n3-4][ix][iz])*(*s)[ix][iz]  -
       		(C0t_6*(*sp)[ix][iz]* (*m)[n3-4][ix ][iz ] + \
                C1t_6*((*sp)[ix][iz] * (*m)[n3-4-1][ix ][iz ]+(*m)[n3-4 + 1][ix ][iz]) + \
                C2t_6*((*sp)[ix][iz] * (*m)[n3-4-2][ix ][iz ]+(*m)[n3-4 + 2][ix ][iz]) + \
                C3t_6*((*sp)[ix][iz] * (*m)[n3-4-3][ix ][iz ]+(*m)[n3-4 + 3][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
      ...
      (*d)[n3-4][ix][iz] += //second time deriv
		//C0t_4*((*sp)[ix][iz] * (*m)[n3-3][ix ][iz ])*(*s)[ix][iz]  - 
       		(C0t_4*(*sp)[ix][iz]* (*m)[n3-3][ix ][iz ] + \
                C1t_4*((*sp)[ix][iz] * (*m)[n3-3-1][ix ][iz ]+(*m)[n3-3 + 1][ix ][iz]) + \
                C2t_4*((*sp)[ix][iz] * (*m)[n3-3-2][ix ][iz ]+(*m)[n3-3 + 2][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
      ...
      (*d)[n3-3][ix][iz] += //second time deriv
		//C0t_2*((*sp)[ix][iz] * (*m)[n3-2][ix ][iz ])*(*s)[ix][iz]  -
       		(C0t_2*(*sp)[ix][iz]* (*m)[n3-2][ix ][iz ] + \
                C1t_2*((*sp)[ix][iz] * (*m)[n3-2-1][ix ][iz ]+(*m)[n3-2 + 1][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
  ...
  for (int it = 5; it < n3-5; it++) { //time
    for (int ix = FAT; ix < n2-FAT; ix++) { //x
      for (int iz = FAT; iz < n1-FAT; iz++) { //z
		...
		//C0t_10*((*sp)[ix][iz] * (*m)[it][ix ][iz ])*(*s)[ix][iz]  -
       		(C0t_10*(*sp)[ix][iz]* (*m)[it][ix ][iz ] + \
                C1t_10*((*sp)[ix][iz] * (*m)[it-1][ix ][iz ]+(*m)[it + 1][ix ][iz]) + \
                C2t_10*((*sp)[ix][iz] * (*m)[it-2][ix ][iz ]+(*m)[it + 2][ix ][iz]) + \
                C3t_10*((*sp)[ix][iz] * (*m)[it-3][ix ][iz ]+(*m)[it + 3][ix ][iz]) + \
                C4t_10*((*sp)[ix][iz] * (*m)[it-4][ix ][iz ]+(*m)[it + 4][ix ][iz]) + \
                C5t_10*((*sp)[ix][iz] * (*m)[it-5][ix ][iz ]+(*m)[it + 5][ix ][iz]))*(*s)[ix][iz]  - \
                //laplacian
...
void WaveReconV7::adjoint(const bool                         add,
  ...
  for (int ix = FAT; ix < n2-FAT; ix++) { //x
    for (int iz = FAT; iz < n1-FAT; iz++) { //z
      (*m)[0][ix][iz] +=   //second time deriv
                         (C1t_2*((*sp)[ix][iz]*(*d)[0][ix ][iz]) + \
                         C2t_4*((*sp)[ix][iz]*(*d)[1][ix ][iz]) + \
                         C3t_6*((*sp)[ix][iz]*(*d)[2][ix ][iz]) + \
                         C4t_8*((*sp)[ix][iz]*(*d)[3][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz]))*(*s)[ix][iz] + \
                         //initial condition 
       			 (*d)[n3-2][ix ][iz ];
      (*m)[1][ix][iz] +=   //second time deriv
			//C0t_2*((*sp)[ix][iz]*(*d)[0][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_2*((*sp)[ix][iz]*(*d)[0][ix ][iz]) + \
                         C1t_4*((*sp)[ix][iz]*(*d)[1][ix ][iz]) + \
                         C2t_6*((*sp)[ix][iz]*(*d)[2][ix ][iz]) + \
                         C3t_8*((*sp)[ix][iz]*(*d)[3][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[0][ix ][iz ] + \
      ...
      (*m)[2][ix][iz] +=   //second time deriv
			//C0t_4*((*sp)[ix][iz]*(*d)[1][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_4*((*sp)[ix][iz]*(*d)[1][ix ][iz]) + \
                         C1t_2*(*d)[1-1][ix ][iz] + C1t_6*((*sp)[ix][iz]*(*d)[1+1][ix ][iz]) + \
                         C2t_8*((*sp)[ix][iz]*(*d)[1+2][ix ][iz]) + \
                         C3t_10*((*sp)[ix][iz]*(*d)[1+3][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[1+4][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[1+5][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[1][ix ][iz ] + \
      ...
      (*m)[3][ix][iz] +=   //second time deriv
			//C0t_6*((*sp)[ix][iz]*(*d)[2][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_6*((*sp)[ix][iz]*(*d)[2][ix ][iz]) + \
                         C1t_4*(*d)[1][ix ][iz] + C1t_8*((*sp)[ix][iz]*(*d)[3][ix ][iz]) + \
                         C2t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz]) + \
                         C3t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[2][ix ][iz ] + \
      ...
      (*m)[4][ix][iz] +=   //second time deriv
                         //C0t_8*((*sp)[ix][iz]*(*d)[3][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_8*((*sp)[ix][iz]*(*d)[3][ix ][iz]) + \
                         C1t_6*(*d)[2][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz]) + \
                         C2t_4*(*d)[1][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz]) + \
                         C3t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[3][ix ][iz ] + \
      ...
      (*m)[5][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[4][ix ][iz]) + \
                         C1t_8*(*d)[3][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz]) + \
                         C2t_6*(*d)[2][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz]) + \
                         C3t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[9][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[4][ix ][iz ] + \
      ...
      (*m)[6][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz])*(*s)[ix][iz]  - 
                        (C0t_10*((*sp)[ix][iz]*(*d)[5][ix ][iz]) + \
                         C1t_10*(*d)[4][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz]) + \
                         C2t_8*(*d)[3][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]) + \
                         C3t_6*(*d)[2][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[9][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[10][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[5][ix ][iz ] + \
                         ...
                         C5z * ((*d)[5][ix ][iz + 5 ] + (*d)[5][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[7][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[6][ix ][iz])+ \
                         C1t_10*(*d)[5][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]) + \
                         C2t_10*(*d)[4][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]) + \
                         C3t_8*(*d)[3][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[9][ix ][iz]) + \
                         C4t_10*((*sp)[ix][iz]*(*d)[10][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[11][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[6][ix ][iz ] + \
                         ...
                         C5z * ((*d)[6][ix ][iz + 5 ] + (*d)[6][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[8][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz])*(*s)[ix][iz] - 
                        (C0t_10*((*sp)[ix][iz]*(*d)[7][ix ][iz]) + \
                         C1t_10*(*d)[6][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]) + \
                         C2t_10*(*d)[5][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[9][ix ][iz]) + \
                         C3t_10*(*d)[4][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[10][ix ][iz]) + \
                         C4t_8*(*d)[3][ix ][iz] + C4t_10*((*sp)[ix][iz]*(*d)[11][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[12][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[7][ix ][iz ]  + \
                         ...
                         C5z * ((*d)[7][ix ][iz + 5 ] + (*d)[7][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[9][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz])*(*s)[ix][iz] -
                        (C0t_10*((*sp)[ix][iz]*(*d)[8][ix ][iz]) + \
                         C1t_10*(*d)[7][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[9][ix ][iz]) + \
                         C2t_10*(*d)[6][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[10][ix ][iz]) + \
                         C3t_10*(*d)[5][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[11][ix ][iz]) + \
                         C4t_10*(*d)[4][ix ][iz] + C4t_10*((*sp)[ix][iz]*(*d)[12][ix ][iz]) + \
                         C5t_10*((*sp)[ix][iz]*(*d)[13][ix ][iz]))*(*s)[ix][iz] - \
			//laplacian
                         (C0x *(*d)[8][ix ][iz ] + \
                         ...
                         C5z * ((*d)[8][ix ][iz + 5 ] + (*d)[8][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-10][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[n3-11][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[n3-11][ix ][iz]) + \
                         C1t_10*(*d)[n3-11-1][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[n3-11+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-11-2][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[n3-11+2][ix ][iz]) + \
                         C3t_10*(*d)[n3-11-3][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[n3-11+3][ix ][iz]) + \
                         C4t_10*(*d)[n3-11-4][ix ][iz] + C4t_10*((*sp)[ix][iz]*(*d)[n3-11+4][ix ][iz]) + \
			...
			//laplacian
                         ...
                         C5z * ((*d)[n3-11][ix ][iz + 5 ] + (*d)[n3-11][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-9][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[n3-10][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[n3-10][ix ][iz]) + \
                         C1t_10*(*d)[n3-10-1][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[n3-10+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-10-2][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[n3-10+2][ix ][iz]) + \
                         C3t_10*(*d)[n3-10-3][ix ][iz] + C3t_10*((*sp)[ix][iz]*(*d)[n3-10+3][ix ][iz]) + \
                         C4t_10*(*d)[n3-10-4][ix ][iz] + C4t_8*((*sp)[ix][iz]*(*d)[n3-10+4][ix ][iz]) + \
      ...
      (*m)[n3-8][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[n3-9][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[n3-9][ix ][iz]) + \
                         C1t_10*(*d)[n3-9-1][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[n3-9+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-9-2][ix ][iz] + C2t_10*((*sp)[ix][iz]*(*d)[n3-9+2][ix ][iz]) + \
                         C3t_10*(*d)[n3-9-3][ix ][iz] + C3t_8*((*sp)[ix][iz]*(*d)[n3-9+3][ix ][iz]) + \
      ...
      (*m)[n3-7][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[n3-8][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_10*((*sp)[ix][iz]*(*d)[n3-8][ix ][iz]) + \
                         C1t_10*(*d)[n3-8-1][ix ][iz] + C1t_10*((*sp)[ix][iz]*(*d)[n3-8+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-8-2][ix ][iz] + C2t_8*((*sp)[ix][iz]*(*d)[n3-8+2][ix ][iz]) + \
                         C3t_10*(*d)[n3-8-3][ix ][iz] + C3t_6*((*sp)[ix][iz]*(*d)[n3-8+3][ix ][iz]) + \
      ...
      (*m)[n3-6][ix][iz] +=   //second time deriv
			//C0t_10*((*sp)[ix][iz]*(*d)[n3-7][ix ][iz])*(*s)[ix][iz] - 
                         (C0t_10*((*sp)[ix][iz]*(*d)[n3-7][ix ][iz]) + \
                         C1t_10*(*d)[n3-7-1][ix ][iz] + C1t_8*((*sp)[ix][iz]*(*d)[n3-7+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-7-2][ix ][iz] + C2t_6*((*sp)[ix][iz]*(*d)[n3-7+2][ix ][iz]) + \
      ...
      (*m)[n3-5][ix][iz] +=   //second time deriv
			//C0t_8*((*sp)[ix][iz]*(*d)[n3-6][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_8*((*sp)[ix][iz]*(*d)[n3-6][ix ][iz]) + \
                         C1t_10*(*d)[n3-6-1][ix ][iz] + C1t_6*((*sp)[ix][iz]*(*d)[n3-6+1][ix ][iz]) + \
                         C2t_10*(*d)[n3-6-2][ix ][iz] + C2t_4*((*sp)[ix][iz]*(*d)[n3-6+2][ix ][iz]) + \
      ...
      (*m)[n3-4][ix][iz] +=   //second time deriv
			//C0t_6*((*sp)[ix][iz]*(*d)[n3-5][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_6*((*sp)[ix][iz]*(*d)[n3-5][ix ][iz]) + \
                         C1t_8*(*d)[n3-5-1][ix ][iz] + C1t_4*((*sp)[ix][iz]*(*d)[n3-5+1][ix ][iz]) + \
			...
			//laplacian
                         ...
                         C5z * ((*d)[n3-5][ix ][iz + 5 ] + (*d)[n3-5][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-3][ix][iz] +=   //second time deriv
			//C0t_4*((*sp)[ix][iz]*(*d)[n3-4][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_4*((*sp)[ix][iz]*(*d)[n3-4][ix ][iz]) + \
                         C1t_6*(*d)[n3-4-1][ix ][iz] + C1t_2*((*sp)[ix][iz]*(*d)[n3-4+1][ix ][iz]) + \
			...
			//laplacian
                         ...
                         C5z * ((*d)[n3-4][ix ][iz + 5 ] + (*d)[n3-4][ix ][iz - 5 ]))*(*sp)[ix][iz];
      (*m)[n3-2][ix][iz] +=   //second time deriv
			//C0t_2*((*sp)[ix][iz]*(*d)[n3-3][ix ][iz])*(*s)[ix][iz]  -
                         (C0t_2*((*sp)[ix][iz]*(*d)[n3-3][ix ][iz]) + \
			...
			//laplacian
                         ...
                         C5z * ((*d)[n3-3][ix ][iz + 5 ] + (*d)[n3-3][ix ][iz - 5 ]))*(*sp)[ix][iz];
    ...
    for (int ix = FAT; ix < n2-FAT; ix++) {
      for (int iz = FAT; iz < n1-FAT; iz++) {
        (*m)[it+1][ix][iz] += //second time deriv
                         //C0t_10*((*sp)[ix][iz]*(*d)[it][ix ][iz])*(*s)[ix][iz] - 
       			 (C0t_10*(*sp)[ix][iz]* (*d)[it][ix ][iz ]+ \
                         C1t_10*((*d)[it-1][ix ][iz ] + (*sp)[ix][iz]*(*d)[it + 1][ix ][iz]) + \
                         C2t_10*((*d)[it-2][ix ][iz ] + (*sp)[ix][iz]*(*d)[it + 2][ix ][iz]) + \
                         C3t_10*((*d)[it-3][ix ][iz ] + (*sp)[ix][iz]*(*d)[it + 3][ix ][iz]) + \
                         C4t_10*((*d)[it-4][ix ][iz ] + (*sp)[ix][iz]*(*d)[it + 4][ix ][iz]) + \
                         C5t_10*((*d)[it-5][ix ][iz ] + (*sp)[ix][iz]*(*d)[it + 5][ix ][iz]))*(*s)[ix][iz]  - \
                         //laplacian
                         (C0x *(*d)[it][ix ][iz ] + \
