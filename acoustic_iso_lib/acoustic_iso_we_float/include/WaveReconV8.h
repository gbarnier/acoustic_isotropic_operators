...
class WaveReconV8 : public Operator<SEP::float3DReg, SEP::float3DReg> {
public:

  WaveReconV8(const std::shared_ptr<SEP::float3DReg>model,
...
class WaveRecon_multi_exp : public Operator<SEP::float4DReg, SEP::float4DReg> {
public:

  WaveRecon_multi_exp(const std::shared_ptr<SEP::float4DReg>model,
