...
class SecondDeriv_V2 : public Operator<SEP::float3DReg, SEP::float3DReg> {
public:

  SecondDeriv_V2(const std::shared_ptr<SEP::float3DReg>model,
...
private:
  ...
  float C0t_2,C1t_2;
  float _dt; // sampling of fast axis squared
  int n1,n2,n3;
};
