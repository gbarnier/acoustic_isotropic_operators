...
if __name__ == '__main__':
    ...
    modelFloat,dataFloat,elasticParamFloat,parObject,waveEquationAcousticOpNew = Acoustic_iso_float_we.waveEquationNewOpInitFloat(sys.argv)
    ...
    if (parObject.getInt("adj",0) == 0):
        ...
        if (parObject.getInt("dp",0)==1):
            ...
            print("new dp")
            waveEquationAcousticOpNew.dotTest(verb=True)
