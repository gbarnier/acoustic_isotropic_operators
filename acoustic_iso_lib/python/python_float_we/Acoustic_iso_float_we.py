...
def waveEquationOpInitFloat_multi_exp(args):
	...
	if(gpuEnable==1):
		...
		op=waveEquationAcousticCpu_multi_exp(modelFloat,dataFloat,slsqFloat,U0,alpha,spongeWidth)
...
#			result=self.pyOp.dotTest(verb,maxError)
#		return result
class waveEquationAcousticCpu_multi_exp(Op.Operator):
	"""Wrapper encapsulating PYBIND11 module for acoustic wave equation"""
