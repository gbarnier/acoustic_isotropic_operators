...
if __name__ == '__main__':
	...
	if (modelInitFile=="None"):
		print("No intitial slsq model provided. Using water slsq.")
	...
	# No regularization
		...
		if(tpow != 0.0):
			...
			if(pyinfo): print("--- No preconditioning ---")
			inv_log.addToLog("--- No preconditioning ---")
			invProb=Prblm.ProblemL2Linear(modelInit,dataFloat,gradioOp,minBound=minBoundVector,maxBound=maxBoundVector,prec=None)
